...
const About = () => {
    return (
        <div id="about" className="overflow-x-hidden">
            <section className="w-full py-10 bg-gradient-to-b via-purple-900 to-gray-900">
                <div className="mx-auto px-6">
                    <div className="flex flex-col gap-6 md:gap-12 lg:flex-row items-center justify-center">
                        {/* Profile Image */}
                        ...
                        <div data-aos="zoom-in-left" className="text-lg text-white max-w-2xl font-medium space-y-4 px-4 sm:px-0">
                            <h2 className="text-4xl text-center lg:text-left font-extrabold text-amber-200 mb-4">
                                About Me
                            </h2>
                            <p className="text-gray-200 text-sm lg:text-xl text-left">
