...
const Contact = () => {
    ...
    return (
        <section id="contact" style={{ position: "relative", overflow: "hidden", padding: "80px 0" }}>
            {/* Grid */}
            <div style={{
            ...
            <div style={{ maxWidth: "1152px", margin: "0 auto", padding: "0 clamp(16px, 4vw, 24px)", position: "relative", zIndex: 1, boxSizing: "border-box" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 280px), 1fr))", gap: "24px", alignItems: "start" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                        {[
                            { icon: <FaEnvelope size={16} />, label: "Email", value: "maskura.begum77@gmail.com", href: "mailto:maskura.begum77@gmail.com", color: "#6366F1" },
                            { icon: <FaPhone size={16} />, label: "Phone", value: "+8801998282899", href: "tel:+8801998282899", color: "#10B981" },
                            { icon: <FaMapMarkerAlt size={16} />, label: "Location", value: "Cumilla, Bangladesh", href: null, color: "#F59E0B" },
                            ...
                            >
                                ...
                                <div style={{ minWidth: 0 }}>
                                    <p style={{ margin: "0 0 2px", fontSize: "10px", color: "#64748B", textTransform: "uppercase", letterSpacing: "0.1em" }}>{label}</p>
                                    {href ? (
                                        <a href={href} style={{ color: "#F1F5F9", fontSize: "clamp(13px, 2vw, 15px)", fontWeight: "500", textDecoration: "none", wordBreak: "break-all" }}>{value}</a>
                                    ) : (
                                        <p style={{ margin: 0, color: "#F1F5F9", fontSize: "clamp(13px, 2vw, 15px)", fontWeight: "500" }}>{value}</p>
                                    )}
                                </div>
                            </div>
                        ))}
                        ...
                        <div style={{
                            ...
                            <p style={{ margin: "0 0 14px", fontSize: "12px", color: "#64748B", textTransform: "uppercase", letterSpacing: "0.1em" }}>Find me on</p>
                            <div style={{ display: "flex", gap: "10px", flexWrap: "wrap" }}>
                                {[
                                    { icon: <FaFacebook size={18} />, href: "https://www.facebook.com/maskura.islam.313", color: "#6366F1" },
                                    { icon: <FaGithub size={18} />, href: "https://github.com/MaskuraBegum", color: "#94A3B8" },
                                    { icon: <FaLinkedin size={18} />, href: "https://www.linkedin.com/in/maskura-begum/", color: "#10B981" },
