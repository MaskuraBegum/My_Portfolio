...
const Header = () => {
    return (
        <div id="header" style={{ position: "relative", overflow: "hidden", background: "#0B0F1A", minHeight: "85vh", display: "flex", alignItems: "center", fontFamily: "'Inter', sans-serif" }}>
            ...
            <div style={{
                ...
                margin: "0 auto", padding: "40px 64px",
                flexWrap: "wrap",
            }}>
                ...
                <div style={{ flex: 1, maxWidth: "580px" }}>
                    ...
                    <p style={{
                        ...
                        color: "#6366F1", fontFamily: "'Courier New', monospace", marginBottom: "18px",
                    }}>
                    ...
                    <h1 style={{
                        ...
                        color: "#F1F5F9", lineHeight: 1.1, letterSpacing: "-0.02em",
                    ...
                    <p style={{
                        ...
                        lineHeight: 1.75, marginBottom: "22px", maxWidth: "460px",
                    }}>
                        Passionate about building innovative solutions with cutting-edge technologies.
                        I turn ideas into real, full-stack web experiences.
                    </p>
                    ...
                    <div style={{ display: "flex", gap: "14px", flexWrap: "wrap", alignItems: "center" }}>
                        <a href="mailto:maskura.begum77@gmail.com" style={{
                        ...
                        >
                            <svg width="17" height="17" viewBox="0 0 24 24" fill="none"><path clipRule="evenodd" d="M3.00977 5.83789C3.00977 5.28561 3.45748 4.83789 4.00977 4.83789H20C20.5523 4.83789 21 5.28561 21 5.83789V17.1621C21 18.2667 20.1046 19.1621 19 19.1621H5C3.89543 19.1621 3 18.2667 3 17.1621V6.16211C3 6.11449 3.00333 6.06765 3.00977 6.0218V5.83789ZM5 8.06165V17.1621H19V8.06199L14.1215 12.9405C12.9499 14.1121 11.0504 14.1121 9.87885 12.9405L5 8.06165ZM6.57232 6.80554H17.428L12.7073 11.5263C12.3168 11.9168 11.6836 11.9168 11.2931 11.5263L6.57232 6.80554Z" fill="currentColor" fillRule="evenodd" /></svg>
                            Contact Me
                        </a>
                        <a href="/resource/MaskuraBegum.pdf" download="Maskura Begum.pdf" style={{
                            display: "flex", alignItems: "center", gap: "8px",
                            padding: "13px 30px", borderRadius: "50px",
                            background: "rgba(16,185,129,0.1)",
                            border: "1.5px solid rgba(16,185,129,0.45)",
                            color: "#10B981", fontWeight: 600, fontSize: "15px",
                            textDecoration: "none", transition: "all 0.25s ease",
                        }}
                ...
                <div style={{ position: "relative", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
                    ...
                    <div style={{
                        ...
                        borderRadius: "50%",
                        background: "conic-gradient(from 0deg, #6366F1, #F59E0B, #10B981, #6366F1)",
