    ...
    <section id="experience" className="py-16 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="max-w-7xl mx-auto text-center text-amber-300">
        ...
        <div className="m-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-8">
          {/* First Card */}
          <motion.div
            className="bg-gray-700 p-8 rounded-2xl shadow-2xl transition-all duration-300 hover:-translate-y-2 hover:bg-gray-600 hover:ring-4 hover:ring-green-400"
            initial={{ opacity: 0, y: 50 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          >
            <h3 className="text-2xl font-semibold text-green-500 mb-4">Creative Problem-Solving</h3>
          ...
          >
            <h3 className="text-2xl font-semibold text-green-500 mb-4">Adaptability & Learning</h3>
            <p className="text-gray-100">
          ...
          >
            <h3 className="text-2xl font-semibold text-green-500 mb-4">Collaboration & Teamwork</h3>
            <p className="text-gray-100">
          ...
          >
            <h3 className="text-2xl font-semibold text-green-500 mb-4">Attention to Detail</h3>
            <p className="text-gray-100">
